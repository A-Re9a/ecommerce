...
export default function Contact() {
  return (
    <div className="bg-gray-50 min-h-screen flex flex-col">
      {/* Header */}
      <header className="bg-white shadow-sm py-4 px-6 flex flex-col md:flex-row md:items-center md:justify-between border-b">
        <div className="flex items-center gap-2 mb-2 md:mb-0">
          <span className="text-teal-600 font-bold text-2xl">Basket</span>
        </div>
        <nav className="flex gap-6 text-gray-700 text-sm items-center">
          <a href="#" className="hover:text-teal-600">Home</a>
          <a href="#" className="hover:text-teal-600">Shop</a>
          <a href="#" className="hover:text-teal-600">Meats & Seafood</a>
          <a href="#" className="hover:text-teal-600">Bakery</a>
          <a href="#" className="hover:text-teal-600">Rewards</a>
          <a href="#" className="hover:text-teal-600">Blog</a>
          <a href="#" className="text-teal-600 font-semibold border-b-2 border-teal-600">Contact</a>
        </nav>
        <div className="flex gap-2 items-center mt-2 md:mt-0">
          <button className="bg-teal-500 text-white px-4 py-1 rounded hover:bg-teal-600 text-sm">Sign up</button>
          <button className="border border-teal-500 text-teal-500 px-4 py-1 rounded hover:bg-teal-50 text-sm">Log in</button>
        </div>
      </header>
